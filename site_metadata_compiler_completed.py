...
def comp(database, metadata, site_info, hole_info):
    ...
    site_metadata = site_metadata[site_metadata['datapoints'].astype(float) >= 4]
    site_metadata = site_metadata[site_metadata['site'] != '796']  # Hydrate-affected
    site_metadata = site_metadata[site_metadata['site'] != '790']
    site_metadata = site_metadata[site_metadata['site'] != '829']  # Unquantified upward flow
    site_metadata = site_metadata[site_metadata['site'] != '1126'] # Brine diffusion
    site_metadata = site_metadata[site_metadata['site'] != '969'] # Evaporite diffusion
